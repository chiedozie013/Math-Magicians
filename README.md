...
```sh
  cd my-folder,
  git clone https://github.com/chiedozie013/math-magicians.git,
  npm install
  npm run start
```
...
Feel free to check the [issues page](https://github.com/chiedozie013/math-magicians/issues).
...
This project is [MIT](https://github.com/chiedozie013/math-magicians/blob/main/LICENSE) licensed.
